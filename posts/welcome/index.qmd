...
I recently moved to [Quarto](https://Quarto.org) to document my code and write reports and saw that it is also possible to create a website with Quarto, which turned out to be surprisingly easy. To make this work, you should have quarto installed and have a basic understanding about markdown (I might do some short tutorial on markdown maybe a bit later).
