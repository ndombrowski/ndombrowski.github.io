...
I changed some things to make these templates fit my personal needs. For example, I added more categories, such as a Projects and Publications, into the navbar and moved my personal information to the starting page instead of having the blog appear there. Everything I did is documented on my GitHub page (more on that below), so if you want to have some inspiration feel free to have a look [here](https://github.com/ndombrowski/ndombrowski.github.io).
